...
path_parse = [base_url, rg_id, endpoint]
...
# POST request to the endoint with headers to Activate the SEP
response = requests.put(request_endpoint, headers=headers)
